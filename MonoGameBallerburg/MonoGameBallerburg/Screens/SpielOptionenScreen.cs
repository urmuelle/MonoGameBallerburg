// <copyright file="SpielOptionenScreen.cs" company="Urs Müller">
...
namespace MonoGameBallerburg.Screens
{
  ...
  public class SpielOptionenScreen : MenuScreen
  {
    private readonly MenuEntry zurueckMenuEntry;

    /// <summary>
    /// Initializes a new instance of the <see cref="SpielOptionenScreen"/> class.
    /// </summary>
    /// <param name="graphicsManager">The graphics manager.</param>
    /// <param name="screenManager">The screen manager.</param>
    public SpielOptionenScreen(IBallerburgGraphicsManager graphicsManager, IScreenManager screenManager)
